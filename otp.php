      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            <img class="big-logo mb-5" src="img/core-img/pryzon-logo.png" alt="" width="100px;">
            ...
            <div class="otp-form mt-5 mx-4">
              <form action="otp-confirm.php" method="">
                <div class="mb-4 d-flex">
                  ...
                  <input class="form-control ps-0" id="phone_number" type="number" placeholder="Enter phone number">
                </div>
