...
<!-- Mirrored from designing-world.com/suha-v2.5.0/forget-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Oct 2021 04:47:07 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><img class="big-logo" src="img/core-img/logo-white.png" alt="">
            ...
            <div class="register-form mt-5 px-4">
              <form action="forget-password-success.php" method="">
