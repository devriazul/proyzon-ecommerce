          ...
          <div class="choose-payment-method">
            ...
            <div class="row justify-content-center g-3">
              ...
              <div class="col-6 col-md-5">
                <div class="single-payment-method"><a class="credit-card" href="checkout-credit-card.php">
              ...
              <!-- Single Payment Method-->
              <div class="col-6 col-md-5">
                <div class="single-payment-method"><a class="bank" href="checkout-bank.php">
                    <svg class="bi bi-building mb-2 text-dark" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
              ...
              <!-- Single Payment Method-->
              <div class="col-6 col-md-5">
                <div class="single-payment-method"><a class="paypal" href="checkout-paypal.php">
              ...
              <!-- Single Payment Method-->
              <div class="col-6 col-md-5">
                <div class="single-payment-method"><a class="cash" href="checkout-cash.php">
